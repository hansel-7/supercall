      ...
      <div className="flex-1 min-h-0 flex flex-col gap-3">
        <div className="flex-1 min-h-0 bg-surface-800/40 rounded-xl border border-white/5 p-3 flex flex-col">
          <div className="flex items-center gap-2 mb-2 pb-2 border-b border-white/5 flex-shrink-0">
            ...
            <span className="text-xs font-medium text-gray-400 uppercase tracking-wider">Key Metrics</span>
          </div>
        ...
        <div className="flex-1 min-h-0 bg-surface-800/40 rounded-xl border border-white/5 p-3 flex flex-col">
          <div className="flex items-center gap-2 mb-2 pb-2 border-b border-white/5 flex-shrink-0">
            ...
            <span className="text-xs font-medium text-gray-400 uppercase tracking-wider">Live Insights</span>
            {insights.length > 0 && (
              <span className="text-[10px] bg-white/10 text-gray-300 px-1.5 py-0.5 rounded-full">{insights.length}</span>
            )}
          </div>
